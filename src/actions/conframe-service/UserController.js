...
export default {
    actions: {
        [UserController.addUser.method] : {
            summary: '添加用户',
            method: 'post',
            url: (payload) => `/api/users/rewrite/save`,
            parameters: [{'in':'body','name':'conVO','description':'conVO','required':true,'schema':{'$ref':'#/definitions/用户管理实体类'}}],
        },
        [UserController.create.method] : {
            summary: '新增用户, 可同时绑定员工。一个员工最多只能绑定一个用户',
            method: 'post',
            url: (payload) => `/api/users`,
            parameters: [{'in':'body','name':'user','description':'user','required':true,'schema':{'$ref':'#/definitions/用户'}}],
        },
        [UserController.delUsers.method] : {
            summary: '删除用户',
            method: 'post',
            url: (payload) => `/api/users/rewrite/delete`,
            parameters: [{'in':'body','name':'delVO','description':'delVO','required':true,'schema':{'$ref':'#/definitions/DeleteVO'}}],
        },
        ...
        [UserController.getDownRole.method] : {
            summary: '根据当前登录用户下级所有角色',
            method: 'get',
            url: (payload) => `/api/users/rewrite/downrole/${payload.roleId}`,
            parameters: [{'name':'roleId','in':'path','description':'roleId','required':true,'type':'string'}],
        },
        [UserController.getLoginUserRole.method] : {
            summary: '获取当前登录用户的角色',
            method: 'get',
            url: (payload) => `/api/users/rewrite/currentUser/role`,
            parameters: [],
        },
        ...
        [UserController.modifyPassword.method] : {
            ...
            parameters: [{'name':'id','in':'path','description':'id','required':true,'type':'string'},{'in':'body','name':'password','description':'password','required':true,'schema':{'$ref':'#/definitions/UserPassword'}}],
        },
        ...
        [UserController.queryUsers.method] : {
            summary: '用户查询',
            method: 'post',
            url: (payload) => `/api/users/rewrite/search`,
            parameters: [{'in':'body','name':'searchParam','description':'用户名,角色Code','required':true,'schema':{'$ref':'#/definitions/用户查询条件'}}],
        },
        ...
        [UserController.updateUser.method] : {
            summary: '修改用户',
            method: 'put',
            url: (payload) => `/api/users/rewrite/${payload.userId}`,
            parameters: [{'in':'body','name':'conVO','description':'conVO','required':true,'schema':{'$ref':'#/definitions/用户管理实体类'}},{'name':'userId','in':'path','description':'userId','required':true,'type':'string'}],
        },
    },
    // state: {},
    // mutations: {},
