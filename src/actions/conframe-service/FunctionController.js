...
export default {
    actions: {
        [FunctionController.create.method] : {
            ...
            parameters: [{'in':'body','name':'model','description':'model','required':true,'schema':{'$ref':'#/definitions/功能'}}],
        },
        ...
        [FunctionController.importFunctions.method] : {
            ...
            parameters: [{'in':'body','name':'functions','description':'functions','required':true,'schema':{'type':'array','items':{'$ref':'#/definitions/CofFunction'}}}],
        },
