...
export default {
    actions: {
        [PositionController.addPositionEmployees.method] : {
            summary: '往岗位下添加员工',
            method: 'put',
            url: (payload) => `/api/positions/${payload.id}/employees/${payload.employeeIds}`,
        ...
        [PositionController.create.method] : {
            summary: '新增',
            method: 'post',
            url: (payload) => `/api/positions`,
            parameters: [{'in':'body','name':'model','description':'model','required':true,'schema':{'$ref':'#/definitions/岗位'}}],
        },
        [PositionController.deleteByIds.method] : {
            summary: '按主键集合(以&#x27;,&#x27;分割)删除',
            method: 'delete',
            url: (payload) => `/api/positions/${payload.ids}`,
            parameters: [{'name':'ids','in':'path','description':'ids','required':true,'type':'string'}],
        },
        [PositionController.findById.method] : {
            summary: '按主键查询',
            method: 'get',
            url: (payload) => `/api/positions/${payload.id}`,
        ...
        [PositionController.pagingByCriteria.method] : {
            summary: '分页查询',
            method: 'get',
        ...
        [PositionController.querySubEmployees.method] : {
            summary: '列出此岗位的员工',
            method: 'get',
            url: (payload) => `/api/positions/${payload.id}/employees`,
        ...
        [PositionController.removePositionEmployees.method] : {
            summary: '从岗位下移除员工',
            method: 'delete',
            url: (payload) => `/api/positions/${payload.id}/employees/${payload.employeeIds}`,
            parameters: [{'name':'employeeIds','in':'path','description':'employeeIds','required':true,'type':'string'},{'name':'id','in':'path','description':'id','required':true,'type':'string'}],
