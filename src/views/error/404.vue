<template>
    <div class="hse_404">
        <div class="box">
            <div class="leftBox">
                <img class="leftBox__parent" :src="img_404" alt="404" /> 
                <img class="leftBox__child left" :src="img_404_cloud" alt="404" />
                <img class="leftBox__child mid" :src="img_404_cloud" alt="404" /> 
                <img class="leftBox__child right" :src="img_404_cloud" alt="404" />
            </div>
            <div class="rightBox">
                <div class="rightBox__headline">抱歉!!!</div>
                <div class="rightBox__info">请检查您输入的网址是否正确，请点击以下按钮返回主页或者发送错误报告</div>
                <a href="/dashboard" class="rightBox__return-home">返回首页</a>
            </div>
        </div>
    </div>
</template>
